...
package com.tomkeuper.bedwars.support.version.v1_21_R6;
...
import com.tomkeuper.bedwars.support.version.v1_21_R6.despawnable.DespawnableAttributes;
import com.tomkeuper.bedwars.support.version.v1_21_R6.despawnable.DespawnableFactory;
import com.tomkeuper.bedwars.support.version.v1_21_R6.despawnable.DespawnableType;
import com.tomkeuper.bedwars.support.version.v1_21_R6.hologram.HoloLine;
import com.tomkeuper.bedwars.support.version.v1_21_R6.hologram.Hologram;
...
public final class v1_21_R6 extends VersionSupport {
    ...
    public v1_21_R6(Plugin plugin, String name) {
        super(plugin, name);
        loadDefaultEffects();
    ...
    public void setSource(TNTPrimed tnt, Player owner) {
        ...
        nmsTNT.j = nmsEntityLiving != null ? EntityReference.a(nmsEntityLiving) : null;
    }
    ...
    public void updatePacketArmorStand(GeneratorHolder gh, Iterable<Player> players) {
        ...
        PacketPlayOutEntityMetadata metadata = new PacketPlayOutEntityMetadata(armorStand.getEntityId(), ((CraftArmorStand) armorStand).getHandle().aC().c());
